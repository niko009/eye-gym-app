...
The app also includes a child-friendly illustrated learning section about how eyes work, screen-related discomfort and gentle breaks in RU/RO/EN. During an active workout, supported mobile browsers keep the display awake and release the lock automatically when the workout closes.
