...
- Frontend: TypeScript, production Vite/PWA build and 16 Vitest tests.
...
- Production host/DNS/SSH, Google OAuth credentials, Telegram bot token and username, BotFather Mini App/menu configuration, VAPID key pair, GA4 Measurement ID and GitHub Environment secrets.
